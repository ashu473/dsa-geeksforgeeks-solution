...
// Approach
// step.1-> find the target and also add the data of root while reaching to target
// step2.-> when root is equal to target the go to the leaves also adding the data from root to leaves
// step3.-> return sum till target - sum from target to leaves
